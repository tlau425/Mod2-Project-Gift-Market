...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { email: @login.email, password: 'secret', password_confirmation: 'secret', username: @login.username } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { email: @login.email, password: 'secret', password_confirmation: 'secret', username: @login.username } }
